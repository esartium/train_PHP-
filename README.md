...
В классе одновременно хранятся как статичные, фиксированные значения (переменные простых типов данных, массивы), так и динамичные (функции). Переменные класса называются свойствами, функции класса - методами.

#### Создание класса:

Делаем отдельный файл, который называется так же, как сам класс (подробнее структуру смотри в train проекте). Названия классов пишутся с большой буквы. 
